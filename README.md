...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/dry-cell-5aaf
```

A live public deployment of this template is available at [https://dry-cell-5aaf.templates.workers.dev](https://dry-cell-5aaf.templates.workers.dev)
